...
FIELD_MAP = {
    ...
    'LFROM'   : 'left_from_num',
    'LTO'   : 'left_to_num',
    'RFROM'   : 'right_from_num',
    'RTO'   : 'right_to_num',
    'LZIP'  : 'left_zip',
    'RZIP'  : 'right_zip',
    'LCOMMCODE' : 'left_city',
    'RCOMMCODE' : 'right_city',
    'STATE_L'   : 'left_state',
    'STATE_R'   : 'right_state',
}
...
VALID_FCC_PREFIXES = (
    #'1', # primary highway with limited access
    #'2', # primary road without limited access
    #'3', # secondary and connecting road
    #'4',  # local, neighborhood, and rural road
    #'5',
    #'6',
    #'7',
    #'8',
